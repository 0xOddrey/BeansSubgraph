...
export class BeansAuctionHouse__auctionResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BeansAuctionHouse extends ethereum.SmartContract {
  static bind(address: Address): BeansAuctionHouse {
    return new BeansAuctionHouse("BeansAuctionHouse", address);
  }

  auction(): BeansAuctionHouse__auctionResult {
    ...
    return new BeansAuctionHouse__auctionResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_auction(): ethereum.CallResult<BeansAuctionHouse__auctionResult> {
    ...
    return ethereum.CallResult.fromValue(
      new BeansAuctionHouse__auctionResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
