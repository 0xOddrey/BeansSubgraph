...
export class BeansDAO__getActionsResult {
...
export class BeansDAO__getReceiptResultValue0Struct extends ethereum.Tuple {
...
export class BeansDAO__proposalsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class BeansDAO extends ethereum.SmartContract {
  static bind(address: Address): BeansDAO {
    return new BeansDAO("BeansDAO", address);
  }
  ...
  getActions(proposalId: BigInt): BeansDAO__getActionsResult {
    let result = super.call(
      "getActions",
    ...
    return new BeansDAO__getActionsResult(
  ...
  try_getActions(
    proposalId: BigInt
  ): ethereum.CallResult<BeansDAO__getActionsResult> {
    let result = super.tryCall(
      "getActions",
      "getActions(uint256):(address[],uint256[],string[],bytes[])",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      new BeansDAO__getActionsResult(
  ...
  getReceipt(
    proposalId: BigInt,
    voter: Address
  ): BeansDAO__getReceiptResultValue0Struct {
    let result = super.call(
      "getReceipt",
    ...
    return result[0].toTuple() as BeansDAO__getReceiptResultValue0Struct;
  }

  try_getReceipt(
    proposalId: BigInt,
    voter: Address
  ): ethereum.CallResult<BeansDAO__getReceiptResultValue0Struct> {
    let result = super.tryCall(
      "getReceipt",
      "getReceipt(uint256,address):((bool,uint8,uint96))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as BeansDAO__getReceiptResultValue0Struct
    );
  }
  ...
  proposals(param0: BigInt): BeansDAO__proposalsResult {
    let result = super.call(
      "proposals",
    ...
    return new BeansDAO__proposalsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposals(
    param0: BigInt
  ): ethereum.CallResult<BeansDAO__proposalsResult> {
    let result = super.tryCall(
      "proposals",
      "proposals(uint256):(uint256,address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
