...
export class BeansDAOLogicV1__getActionsResult {
...
export class BeansDAOLogicV1__getReceiptResultValue0Struct extends ethereum.Tuple {
...
export class BeansDAOLogicV1__proposalsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class BeansDAOLogicV1 extends ethereum.SmartContract {
  static bind(address: Address): BeansDAOLogicV1 {
    return new BeansDAOLogicV1("BeansDAOLogicV1", address);
  }
  ...
  beans(): Address {
    let result = super.call("beans", "beans():(address)", []);

    return result[0].toAddress();
  }

  try_beans(): ethereum.CallResult<Address> {
    let result = super.tryCall("beans", "beans():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getActions(proposalId: BigInt): BeansDAOLogicV1__getActionsResult {
    let result = super.call(
      "getActions",
    ...
    return new BeansDAOLogicV1__getActionsResult(
  ...
  try_getActions(
    proposalId: BigInt
  ): ethereum.CallResult<BeansDAOLogicV1__getActionsResult> {
    let result = super.tryCall(
      "getActions",
      "getActions(uint256):(address[],uint256[],string[],bytes[])",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      new BeansDAOLogicV1__getActionsResult(
  ...
  getReceipt(
    proposalId: BigInt,
    voter: Address
  ): BeansDAOLogicV1__getReceiptResultValue0Struct {
    let result = super.call(
      "getReceipt",
    ...
    return changetype<BeansDAOLogicV1__getReceiptResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getReceipt(
    proposalId: BigInt,
    voter: Address
  ): ethereum.CallResult<BeansDAOLogicV1__getReceiptResultValue0Struct> {
    let result = super.tryCall(
      "getReceipt",
      "getReceipt(uint256,address):((bool,uint8,uint96))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<BeansDAOLogicV1__getReceiptResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  proposals(param0: BigInt): BeansDAOLogicV1__proposalsResult {
    let result = super.call(
      "proposals",
    ...
    return new BeansDAOLogicV1__proposalsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposals(
    param0: BigInt
  ): ethereum.CallResult<BeansDAOLogicV1__proposalsResult> {
    let result = super.tryCall(
      "proposals",
      "proposals(uint256):(uint256,address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BeansDAOLogicV1__proposalsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
